...
const copy = {
  en: {
    ...
    pngOnly: "Available for PNG exports",
    pages: "Pages",
    page: "Page",
    addPage: "Add Page",
  ...
  ar: {
    ...
    size: "الحجم",
    customSize: "حجم مخصص",
    horizontalMargin: "الهامش الجانبي",
    verticalMargin: "أعلى / أسفل",
    spacing: "التباعد",
    cornerRadius: "الزوايا",
    centimeterNote: "القياسات الفعلية تستخدم 300 نقطة/بوصة وتُحفظ تلقائياً.",
    alwaysShowMeasurements: "إظهار قياسات الإطارات دائماً",
    ...
    pngOnly: "متاح عند التصدير بصيغة PNG",
    pages: "الصفحات",
    page: "صفحة",
    addPage: "إضافة صفحة",
